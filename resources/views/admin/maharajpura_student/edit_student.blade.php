                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-12" action="{{url('/edit/StudentMaharajpura/'.$print->id)}}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group col-sm-6">
                                  ...
                                  <input type="text" name="next_medium" value="{{$print->next_medium}}" class="form-control">
                                   ...
                                   <input type="text" name="subject" value="{{$print->subject}}" class="form-control">
                                    ...
                                    <label>SSSM ID No.</label><br>
                                 
                                   <input type="text" name="sssm_id" value="{{$print->sssm_id}}" class="form-control">
                                       <br>


                                    <label>Aadhar No.</label><br>
                                 
                                   <input type="text" name="aadhar_number" value="{{$print->aadhar_number}}" class="form-control">
                                       <br>

                                    <label>Student Bank A/c No.</label><br>
                                 
                                   <input type="text" name="bank_account" value="{{$print->bank_account}}" class="form-control">
                                       <br>
