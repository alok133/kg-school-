...
<body>
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                 <label style="font-weight: bold;">13. &nbsp;SSSM ID NO. :</label> &nbsp;
                                 {{$print->sssm_id}} &nbsp; <label style="font-weight: bold;">Aadhar Number :</label>  &nbsp;  {{$print->aadhar_number}} &nbsp; <label style="font-weight: bold;">Student Bank A/c : No. </label> &nbsp; {{$print->bank_account}}
                              </div>
