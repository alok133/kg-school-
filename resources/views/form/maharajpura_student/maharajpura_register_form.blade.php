               ...
               <div class="container">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <h1 style="text-align: center;font-weight: bold;">K.G. Children Senior School (Maharajpura)</h1>
                      <br>
                        <div class="widget">
                           <div class="widget-body">
                              <form method="post" action="{{url('/kg-maharajpura')}}" enctype="multipart/form-data" onsubmit="return myfun()">
                                @csrf
 ...
 <!-- **************************Right Section*********************** -->
                                    ...
                                    <div class="form-group col-sm-6">
                                      ...
                                      <label for="exampleInputEmail1">Bonafide Residence Of M.P. or other</label> <br>
                                       ...
                                       <label for="exampleInputEmail1">SSSM ID No.</label> <br>
                                       <input type="text" placeholder="Enter SSSM ID Number" name="sssm_id" class="form-control">

                                        <br>

                                         <label for="exampleInputEmail1">Aadhar No.</label> <br>
                                       <input type="text" placeholder="Enter Your Aadhar Number" name="aadhar_number" class="form-control">

                                        <br>

                                         <label for="exampleInputEmail1">Student Bank A/c No.</label> <br>
                                       <input type="text" placeholder="Enter Your Bank Account Number" name="bank_account" class="form-control">
